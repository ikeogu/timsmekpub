        ...
        <div class="row">
            <div class="col-md-8">
               <div class="blog-read mt-5">
                    ...
                    <div class="blog-body">
                      ...
                      <img src="../storage/blog_post/{{$blog->image}}" alt="{{$blog->caption}}"  height="370" width="339" id="blog_image">
            ...
            <div class="col-md-4">
                ...
                <div class="sidebar-box">
                  ...
                  <div class="d-flex mt-2 p-2 pt-2">
                    <a href="/blog/{{$item->id}}" class="blog-img mr-4 ">
                      <img src="../storage/blog_post/{{$item->image}}" alt=".." class="img-fluid" width="auto">
                    </a>
                    <div class="text">
                      <h4 class="heading">
                      <a href="/blog/{{$item->id}}">{{$item->caption}}</a>
                      </h4>
                      <div class="meta">
                        <div>
