  ...
  <div id="wrapper">
   <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="sidebar-brand-text mx-3">Chizzy <sup>S</sup></div>
        </a>
        ...
        <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('payments')}}" aria-expanded="true">
            <i class="fas fa-fw fa-wrench"></i>
            <span>Payments Recieved Online</span>
        </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container my-auto">
            ...
            <span>Copyright &copy; Chizzy Savings {{date('Y')}}</span>
            </div>
        </div>
        </footer>
        <!-- End of Footer -->
