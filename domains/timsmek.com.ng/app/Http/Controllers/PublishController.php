...
class PublishController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('content')){
            ...
            //upload image
            $path =  $request->file('content')->storeAs('public_html/publish/', $fileNameToSave);
...
//             $book_content = data_get($ace,'url');
        ...
        if($request->hasFile('cover_page')){
            ...
            //upload image
            $path = $request->file('cover_page')->storeAs('public_html/cover_page/', $fileNameToStore);
    ...
    public function update(Request $request, $publish)
    {
        ...
        $p->content= $fileNameToSave;
        $p->save();
        Publish::whereId($publish)->update($request->except(['_method','_token','cover_page','content']));
