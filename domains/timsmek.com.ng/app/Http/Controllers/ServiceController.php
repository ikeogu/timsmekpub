...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('image')){
            ...
            //upload image
            $path = $request->file('image')->storeAs('public_html/service/', $fileNameToStore);
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        $s->image = $fileNameToStore;
        $s->save();
       Service::whereId($id)->update($request->except(['_method','token','image']));
